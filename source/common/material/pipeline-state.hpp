...
namespace our
{
    ...
    struct PipelineState
    {
        ...
        void setup() const
        {
            ...
            // it to control enable and diable the writing to th depth buffer and independent to depth enabling or not
            glDepthMask(depthMask);
            // to control writing to the color buffer, which stores the final color values for each pixel in the framebuffer. By default, all color components (red, green, blue, and alpha) are enabled for writing.
