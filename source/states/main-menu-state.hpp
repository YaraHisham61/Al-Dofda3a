...
class MainMenuState : public our::State
{
    ...
    void onInitialize() override
    {
        ...
        menuMaterial->texture = our::texture_utils::loadImage("assets/textures/main-menu.png");
        ...
        highlightMaterial->tint = glm::vec4(0.5f, 1.0f, 0.0f, 1.0f);
        ...
        buttons[0].position = {760.0f, 558.0f};
        buttons[0].size = {480.0f, 66.0f};
        buttons[0].action = [this]()
        { this->getApp()->changeState("play"); };

        buttons[1].position = {760.0f, 634.0f};
        buttons[1].size = {480.0f, 66.0f};
